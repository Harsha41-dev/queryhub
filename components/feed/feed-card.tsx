...
export function FeedCard({
  ...
  // update UI immediately, then confirm with the server
  ...
  // follow or unfollow the question
  ...
  // share via browser share sheet, or just copy the link
